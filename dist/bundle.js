...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PhotoJsx = __webpack_require__(160);

	var _PhotoJsx2 = _interopRequireDefault(_PhotoJsx);

	console.log(new _mymoduleJs2['default']({ test: 1 }).options.test);

	_reactDom2['default'].render(_react2['default'].createElement(_PhotoJsx2['default'], { src: __webpack_require__(165) }), document.getElementById('app'));
	...
	var Photo = (function (_React$Component) {
		...
		_createClass(Photo, [{
			...
			value: function render() {
				return _react2['default'].createElement('img', { src: this.props.src, onClick: this.handleLike.bind(this), className: this.state.like ? 'hide' : 'show' });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "f32eaf6be0ed6b90c8f895186f544b03.jpg";
